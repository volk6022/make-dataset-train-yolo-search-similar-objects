...
import similarity_model_learning.network_and_dataloader as n_d
...
if __name__ == "__main__":
    ...
    # with open(Settings.output_predictions_json_file, 'r', encoding='utf-8') as f:
    # # with open('predictions_with_embeddings_dino_not_siamese.json', 'r', encoding='utf-8') as f:
    #     predictions_with_embeddings = json.load(f)

    # batch_size=128
    # # model = n_d.SiameseNetwork(3136)
    # model = n_d.SiameseNetwork(1024)
    # criterion = nn.MSELoss()
    # loaders = DataLoaders.from_dsets(
    #     n_d.SiamesePairedDataset_transform(load_embedding_model=False), 
    #     n_d.SiamesePairedDataset_transform(load_embedding_model=False), 
    #     bs=batch_size,
    #     valid_bs=batch_size,
    #     device='cuda',
    ...
    # with torch.no_grad():
    #     for image in predictions_with_embeddings:
    #         image_objects = image["objects"]
    #         for obj in image_objects:
    #             embedding = n_d.place_embedding_on_device(obj["embedding"], 'cuda')
    #             pred = learn.model.predict_single_embedding(embedding).flatten().cpu().numpy().tolist()
    #             obj["embedding"] = pred
    
    # save_json(Settings.output_predictions_json_file, predictions_with_embeddings)
    # del predictions_with_embeddings, model
    ...
    # verified_pairs = similarity_verification.verify_similarities(
    #     predictions_with_embeddings_path=Settings.output_predictions_json_file,
    #     sorted_pairs_path=Settings.output_similarity_json_file,
    #     formated_images_folder=Settings.formated_images_folder,
    #     verification_method=Settings.contour_verification_method,
    #     verify_180_rotation=True,
    ...
    #     saving_contour_debug_dir=Settings.contour_saving_debug_dir,
    ...
    #     verification_method=Settings.image_features_verification_method,
    #     verify_180_rotation=True,
    #     image_features_debug_dir=Settings.image_features_CORNER_debug_dir,
    #     image_features_method=Settings.image_features_CORNER_method,
    #     image_features_similarity_threshold=Settings.image_features_CORNER_similarity_threshold
    # )
    # verified_pairs = similarity_verification.verify_similarities(
    #     predictions_with_embeddings_path=Settings.output_predictions_json_file,
    #     sorted_pairs_path=Settings.output_similarity_json_file,
    ...
    #     verification_method=Settings.image_features_verification_method,
    #     verify_180_rotation=True,
    #     image_features_debug_dir=Settings.image_features_BLOB_debug_dir,
    #     image_features_method=Settings.image_features_BLOB_method,
    #     image_features_similarity_threshold=Settings.image_features_BLOB_similarity_threshold
    # )
    # verified_pairs = similarity_verification.verify_similarities(
    #     predictions_with_embeddings_path=Settings.output_predictions_json_file,
    #     sorted_pairs_path=Settings.output_similarity_json_file,
    ...
    #     verification_method=Settings.image_features_verification_method,
    #     verify_180_rotation=True,
    #     image_features_debug_dir=Settings.image_features_TEXTURE_debug_dir,
    #     image_features_method=Settings.image_features_TEXTURE_method,
    #     image_features_similarity_threshold=Settings.image_features_TEXTURE_similarity_threshold
    # )
    verified_pairs = []
